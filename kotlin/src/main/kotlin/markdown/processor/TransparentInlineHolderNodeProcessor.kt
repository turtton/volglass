 ...
 */
open class TransparentInlineHolderNodeProcessor<Type, Parent>(private val renderFrom: Int = 0, private val renderTo: Int = 0) : SingleParagraphNodeProvider<Type, Parent>() {
