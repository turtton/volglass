...
interface NodeProcessor<out Tag, in Parent> {
    fun <Visitor> processNode(visitor: Visitor, markdownText: String, node: ASTNode) where Visitor : TagConsumer<Tag, Parent>, Visitor : NodeVisitor
}
...
interface SandwichNodeProcessor<out Tag, in Parent> : NodeProcessor<Tag, Parent> {
    ...
    override fun <Visitor> processNode(visitor: Visitor, markdownText: String, node: ASTNode) where Visitor : TagConsumer<Tag, Parent>, Visitor : NodeVisitor {
